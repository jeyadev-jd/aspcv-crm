...
The report is structured in six chapters, mirroring the academic internship report format: Introduction and Background, Literature / Market Context, Proposed Methodology (CRM pipeline), System Implementation (data), Results and Analysis, and Conclusion with strategic recommendations.
\end{mdframed}
