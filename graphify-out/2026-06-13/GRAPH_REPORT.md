# Graph Report - ASPCV CRM  (2026-06-12)

## Corpus Check
- 228 files · ~1,627,981 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1587 nodes · 1920 edges · 162 communities (146 shown, 16 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 88 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9b29f63`
...
1. `authenticate()` - 32 edges
2. `requirePermission()` - 28 edges
3. `AuthRequest` - 22 edges
4. `useAuthStore` - 21 edges
5. `compilerOptions` - 20 edges
6. `useIsMobile()` - 18 edges
7. `compilerOptions` - 16 edges
8. `Skills by Category` - 15 edges
9. `Dynamic RBAC + Approval-Gated Mutations Implementation Plan` - 15 edges
10. `Leads()` - 13 edges
...
- `Sidebar()` --calls--> `useAuthStore`  [INFERRED]
  frontend/src/components/layout/Sidebar.tsx → frontend/src/lib/authStore.ts
...
- `LoginPage()` --calls--> `useAuthStore`  [INFERRED]
  frontend/src/components/auth/LoginPage.tsx → frontend/src/lib/authStore.ts
- `ProtectedRoute()` --calls--> `useAuthStore`  [INFERRED]
  frontend/src/components/auth/ProtectedRoute.tsx → frontend/src/lib/authStore.ts
...
Cohesion: 0.15
Nodes (16): discussionSchema, installationSchema, leadSchema, loginSchema, projectSchema, ticketSchema, userSchema, AuthRequest (+8 more)
...
Cohesion: 0.07
Nodes (20): card, cohortData, DATE_RANGES, dealsTrend, forecastData, funnelData, geoData, heatmapDays (+12 more)
...
Cohesion: 0.06
Nodes (35): author, dependencies, bcrypt, cors, dotenv, express, jsonwebtoken, multer (+27 more)

### Community 5 - "Frontend Package Config"
Cohesion: 0.06
Nodes (32): dependencies, axios, class-variance-authority, clsx, date-fns, lucide-react, @radix-ui/react-avatar, @radix-ui/react-checkbox (+24 more)

### Community 6 - "Accounts & CRM Context"
Cohesion: 0.10
Nodes (21): ApiContact, useApiContacts(), useCreateContact(), useDeleteContact(), useUpdateContact(), useCrmData(), Accounts(), blankForm (+13 more)
...
Cohesion: 0.06
Nodes (35): ComponentMovement, RawComponent, useAssignComponent(), useComponents(), useCreateComponent(), useReturnComponent(), useUpdateComponent(), ContactEvent (+27 more)
...
Cohesion: 0.15
Nodes (13): devDependencies, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, tailwindcss, @tailwindcss/vite (+5 more)
...
Cohesion: 0.11
Nodes (19): DEAL_STAGES, DealAPI, STAGE_LABEL, useCreateDeal(), useDeals(), useDeleteDeal(), useUpdateDeal(), useUpdateDealStage() (+11 more)
...
Cohesion: 0.08
Nodes (30): MaterialRequest, MRItem, useApproveMaterialRequest(), useCreateMaterialRequest(), useMaterialRequests(), useRejectMaterialRequest(), PROJECT_STATUSES, ProjectAPI (+22 more)
...
Cohesion: 0.18
Nodes (11): Discussion, DISCUSSION_CATEGORIES, DISCUSSION_TYPES, DiscussionParticipant, useCreateDiscussion(), useDeleteDiscussion(), useDiscussions(), blankForm (+3 more)
...
Cohesion: 0.09
Nodes (26): Lead, LeadContact, LeadOwner, LeadSourceEntry, useChangeLeadStatus(), useCreateLead(), useDeleteLead(), useLeads() (+18 more)
...
Cohesion: 0.20
Nodes (10): useCurrency(), avatarColors, blankForm, fmtAmt(), initInvoices, Invoice, Invoices(), statusStyle (+2 more)
...
Cohesion: 0.33
Nodes (4): LoginPage(), useIsMobile(), CalendarPage(), Kanban()

### Community 52 - "Community 52"
Cohesion: 0.25
Nodes (7): enabledPlugins, auth0@claude-plugins-official, linear@claude-plugins-official, playground@claude-plugins-official, ui-ux-pro-max@ui-ux-pro-max-skill, hooks, PreToolUse

### Community 53 - "Community 53"
Cohesion: 0.33
Nodes (5): Commands, communication — MANDATORY, graphify — MANDATORY token-saving protocol, REQUIRED order of operations, Why

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (53): ProtectedRoute(), AttendanceLocation, AttendanceRecord, useAllAttendance(), useAttendanceLocations(), useCheckIn(), useCheckOut(), useCreateAttendanceLocation() (+45 more)
...
Cohesion: 0.11
Nodes (18): 1. **Lead Research Assistant** (`lead-research-assistant/`), 2. **Document Skills** (`document-skills/`), 3. **File Organizer** (`file-organizer/`), 4. **Invoice Organizer** (`invoice-organizer/`), 5. **Google Drive Automation** (`googledrive-automation/`), 6. **Slack Bot Automation** (`slackbot-automation/`), 7. **MCP Builder** (`mcp-builder/`), 8. **Skill Creator** (`skill-creator/`) (+10 more)

### Community 58 - "Community 58"
Cohesion: 0.10
Nodes (21): signToken(), verifyToken(), prisma, authenticate(), errorHandler(), router, router, router (+13 more)

### Community 59 - "Community 59"
Cohesion: 0.20
Nodes (8): age(), fmt(), LeadDetailPanel(), Props, stageLabel, stageStyle, STATUS_LABEL, statusStyle

### Community 60 - "Community 60"
Cohesion: 0.20
Nodes (11): Products API, aspcv-logo.png, Frontend, index.html, src/main.tsx, Dashboard Page, Products Page, React 19 (+3 more)

### Community 62 - "Community 62"
Cohesion: 0.20
Nodes (9): ASPCV CRM Skills, Configuration, Example 1: Research Leads, Example 2: Organize Documents, Example 3: Process Invoice, Included Skills, Next Steps, Quick Start (+1 more)

### Community 63 - "Community 63"
Cohesion: 0.25
Nodes (4): INCLUDE_FULL, ownerSchema, router, STATE_CODES

### Community 64 - "Community 64"
Cohesion: 0.25
Nodes (5): ACCOUNTANT_ROLES, BIZHEAD_ROLES, INCLUDE, MANAGER_ROLES, router
...
Cohesion: 0.33
Nodes (5): Designation, useCreateDesignation(), useDesignations(), DesignationInput(), Props

### Community 104 - "Community 104"
Cohesion: 0.33
Nodes (5): Industry, useCreateIndustry(), useIndustries(), IndustryInput(), Props
...
Cohesion: 0.29
Nodes (5): PERMISSIONS, prisma, ROLE_DEFS, STANDARD_DESIGNATIONS, STANDARD_INDUSTRIES

### Community 148 - "Community 148"
Cohesion: 0.24
Nodes (7): requirePermission(), router, upload, router, router, cache, invalidate()
...
Cohesion: 0.29
Nodes (5): AppLayout(), navGroups, NavItem, Sidebar(), SidebarProps

### Community 159 - "Community 159"
Cohesion: 0.50
Nodes (4): Kanban API, @hello-pangea/dnd, @hello-pangea/dnd, Kanban Board Page

### Community 165 - "Community 165"
Cohesion: 0.20
Nodes (13): companySchema, contactSchema, dealSchema, checkApprovalToken(), consumeApprovalToken(), resolvePermission(), getScopeFilter(), INCLUDE (+5 more)

## Knowledge Gaps
- **923 isolated node(s):** `PreToolUse`, `ui-ux-pro-max@ui-ux-pro-max-skill`, `playground@claude-plugins-official`, `linear@claude-plugins-official`, `auth0@claude-plugins-official` (+918 more)
...
- **Why does `useIsMobile()` connect `Community 51` to `Accounts & CRM Context`, `Community 41`, `Module Registry`, `Community 43`, `Prisma Schema & DB Models`, `Discussion & Timeline Services`, `Community 47`, `File Storage Abstraction`, `TanStack Query Hooks`, `Shared UI Components`, `Kanban & Tasks Pages`, `Invoices Module`, `Community 158`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `useCurrency()` connect `Invoices Module` to `Accounts & CRM Context`, `Prisma Schema & DB Models`, `Discussion & Timeline Services`, `File Storage Abstraction`, `TanStack Query Hooks`, `Community 145`, `Shared UI Components`, `Kanban & Tasks Pages`, `Community 59`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `Community 54` to `Auth Pages (Login/Protected)`, `TanStack Query Hooks`, `Community 51`, `Community 158`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Are the 3 inferred relationships involving `useAuthStore` (e.g. with `LoginPage()` and `ProtectedRoute()`) actually correct?**
  _`useAuthStore` has 3 INFERRED edges - model-reasoned connections that need verification._
- **What connects `PreToolUse`, `ui-ux-pro-max@ui-ux-pro-max-skill`, `playground@claude-plugins-official` to the rest of the system?**
