...
## Summary
- 1588 nodes · 1834 edges · 163 communities (148 shown, 15 thin omitted)
...
1. `authenticate()` - 27 edges
2. `useAuthStore` - 21 edges
3. `AuthRequest` - 21 edges
4. `compilerOptions` - 20 edges
5. `useIsMobile()` - 18 edges
6. `compilerOptions` - 16 edges
7. `Skills by Category` - 15 edges
8. `Dynamic RBAC + Approval-Gated Mutations Implementation Plan` - 15 edges
9. `Leads()` - 13 edges
...
Cohesion: 0.12
Nodes (21): companySchema, contactSchema, dealSchema, discussionSchema, installationSchema, loginSchema, projectSchema, ticketSchema (+13 more)
...
Cohesion: 0.09
Nodes (23): dependencies, axios, class-variance-authority, clsx, date-fns, lucide-react, @radix-ui/react-avatar, @radix-ui/react-checkbox (+15 more)

### Community 6 - "Accounts & CRM Context"
Cohesion: 0.17
Nodes (13): ApiContact, useApiContacts(), useCreateContact(), useDeleteContact(), useUpdateContact(), avatarColor(), avatarColors, blankForm (+5 more)
...
Cohesion: 0.06
Nodes (36): ComponentMovement, RawComponent, useAssignComponent(), useComponents(), useCreateComponent(), useReturnComponent(), useUpdateComponent(), ContactEvent (+28 more)
...
Cohesion: 0.12
Nodes (11): prisma, errorHandler(), router, router, router, router, router, router (+3 more)
...
Cohesion: 0.15
Nodes (11): signToken(), verifyToken(), authenticate(), router, router, router, router, router (+3 more)
...
Cohesion: 0.15
Nodes (14): Products API, aspcv-logo.png, typescript, Frontend, typescript, index.html, src/main.tsx, Dashboard Page (+6 more)
...
Cohesion: 0.22
Nodes (5): leadSchema, INCLUDE_FULL, ownerSchema, router, STATE_CODES

### Community 64 - "Community 64"
Cohesion: 0.22
Nodes (6): ACCOUNTANT_ROLES, BIZHEAD_ROLES, INCLUDE, MANAGER_ROLES, REQUESTOR_ROLES, router
...
Cohesion: 0.29
Nodes (5): requirePermission(), router, router, router, invalidate()
...
Cohesion: 0.33
Nodes (5): resolvePermission(), getScopeFilter(), cache, getCached(), setCached()

## Knowledge Gaps
- **924 isolated node(s):** `prisma`, `ROLE_DEFS`, `PERMISSIONS`, `STANDARD_INDUSTRIES`, `STANDARD_DESIGNATIONS` (+919 more)
...
- **Why does `useIsMobile()` connect `Community 51` to `Accounts & CRM Context`, `Community 41`, `Module Registry`, `Community 43`, `Prisma Schema & DB Models`, `Discussion & Timeline Services`, `Community 47`, `File Storage Abstraction`, `TanStack Query Hooks`, `Shared UI Components`, `Kanban & Tasks Pages`, `Invoices Module`, `Community 154`, `Community 158`?**
...
- **Why does `Leads()` connect `Kanban & Tasks Pages` to `Auth Pages (Login/Protected)`, `Community 51`, `Community 54`, `Invoices Module`?**
...
- **What connects `prisma`, `ROLE_DEFS`, `PERMISSIONS` to the rest of the system?**
